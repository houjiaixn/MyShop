...
<tr>
<td colspan="2" align="center">账号注销
</td>
</tr>
<tr>
<td>账号</td>
...
<input type="hidden" name="us" value="3">
<input type="submit" style="color:#faa755" value="注销">
</td>
</tr>
</table>
</form>
<div class="w" align="center">
    <div id="footer-2013">
        <div class="links">
        		<input rel="nofollow" type="button" style="color:#FFFF66" onclick="location.href='register.jsp'" value="返回注册">
            |
            		<input rel="nofollow" type="button" style="color:#FFFF66" onclick="location.href='login.jsp'" value="返回登录">
        </div>
